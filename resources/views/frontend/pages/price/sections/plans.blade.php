<section class="py-5 bg-light">
    <div class="text-center mx-auto pb-3 wow fadeInUp" style="max-width: 800px;">
        <h1 class="text-uppercase text-head pt-5">Our Pricing Plans</h1>
        <p class="sub-head mb-3">Choose the right plan that fits your business needs.</p>
    </div>
            ...
            <div class="col-md-4">
                <div class="p-4 bg-white shadow-sm rounded text-center h-100">
                    ...
                    <ul class="list-unstyled text-start mb-3">
                        ...
                        <li class="mb-2"><i class="bi bi-check2-circle text-primary me-2"></i>Feature 3</li>
                    </ul>
                    <button class="btn btn-primary btn-lg rounded-pill">Get Started</button>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="p-4 bg-white shadow-sm rounded text-center h-100 border border-primary">
                    ...
                    <ul class="list-unstyled text-start mb-3">
                        ...
                        <li class="mb-2"><i class="bi bi-check2-circle text-primary me-2"></i>Feature 2</li>
                        <li class="mb-2"><i class="bi bi-check2-circle text-primary me-2"></i>Feature 3</li>
                        <li class="mb-2"><i class="bi bi-check2-circle text-primary me-2"></i>Feature 4</li>
                    </ul>
                    <button class="btn btn-primary btn-lg rounded-pill">Get Started</button>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="p-4 bg-white shadow-sm rounded text-center h-100">
                    ...
                    <ul class="list-unstyled text-start mb-3">
                        ...
                        <li class="mb-2"><i class="bi bi-check2-circle text-primary me-2"></i>Unlimited Users</li>
                    </ul>
                    <button class="btn btn-primary btn-lg rounded-pill">Get Started</button>
                </div>
            </div>
