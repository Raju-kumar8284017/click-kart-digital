...
@section('content')
   ...
   @include('frontend.pages.services.ui-ux-design.sections.banner')

   @include('frontend.common.choosen')

   @include('frontend.pages.services.ui-ux-design.sections.what-we-do')

   @include('frontend.pages.services.ui-ux-design.sections.include-social-media')
